...
<br>
        <input class="form_button" type="button" onclick="history.back();" value="Back"/>
...
<form id="changeDriver" action="/orders/${order.id}" method="post">
    ...
    order.statusOrder == "Заказ отменен" >
        <input class="form_button" type="submit" id="setDriver" disabled hidden value="Установить водителя">Установить водителя</input>
    <#else>
        <input class="form_button" type="submit" id="setDriver" disabled value="Установить водителя">Установить водителя</input>
    </#if>
</form>
<form id="cancelOrder" action="/orders/${order.id}/cancelorder" method="post">
    ...
    order.statusOrder != "Заказ завершен" &&
    order.statusOrder != "Заказ отменен" >
        <button class="form_button" type="submit" id="cancelButton" value="Отменить заказ">Отменить заказ</button>
    </#if>
</form>
...
<form id="deleteOrder" action="/orders/${order.id}" method="post">
    ...
    <button class="form_button" type="submit" value="Удалить">Удалить</button>
</form>
